...
st.header("Daira - Resume Analyzer")
...
# Before your submit buttons, create a columns object
col1, col2, col3, col4 = st.columns(4)

# Place each button in a column using the `with` syntax
with col1:
...
with col3:
    submit3 = st.button("Keywords - Missing")

with col4:
    submit4 = st.button("Percentage Scoring")

# For the input prompt, you can create a single column to span across if you want
col_query, _ = st.columns([3, 1])  # Adjust the ratio if needed
...
footer = """
---
#### Made By [Daira](https://www.linkedin.com/company/daira-edtech/mycompany/?viewAsMember=true)
*Where every step is a continuation*
"""
